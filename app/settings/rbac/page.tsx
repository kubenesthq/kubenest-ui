...
const permissions = [
  ...
  { resource: 'Apps', admin: true, developer: true, viewer: true },
  { resource: 'Create App', admin: true, developer: true, viewer: false },
  { resource: 'Update App', admin: true, developer: true, viewer: false },
  { resource: 'Delete App', admin: true, developer: false, viewer: false },
